...
<body>
  <div class="wrapper">
    <form id="urlForm" action="#" autocomplete="off">
          ...
          <?php
            while($row = mysqli_fetch_assoc($sql2)){
              ?>
                <div class="data">
                <li>
                  <!-- Redirect to internal db link <a href="<?php echo $domain.$row['short_url'] ?>" target="_blank"> -->
                    <a href="<?php echo $row['original_url'] ?>" target="_blank">
                  <?php
  ...
  <div class="popup-box">
  <div class="info-box">This is your shortened link. You can also edit your short link then save it.</div>
